  ...
  return (
    <>
      ...
      <div className="bg-[#f3f3f3]">
        {/* 头部 */}
        <div className="bg-[#fff] h-[60px] px-[20px] flex justify-between items-center">
          {/* logo+标题 */}
          <div className="flex justify-start items-center">
            ...
            <h2 className="text-[20px] ml-[12px] font-[700]">
              一秒快送后台管理系统
            </h2>
          </div>

          {/* 用户 */}
          <Popover placement="bottomRight" content={content} arrow={true}>
            <span className="rounded-[50%] w-[32px] h-[32px] bg-[#ccc] flex justify-center items-center">
              <Icon icon="el:user" color="white" className="text-[16px]" />
            </span>
          </Popover>
        </div>
      </div>
